<script>
	...
	function paragraphify(code, pNum) {
		...
		let senCountry = countryify(code, pNum+rankToSkip)
	  ...
	  var changeTotNextCountry = senTopicNextCountry.split("_")
		...
		if (regionRank[pNum]['sqr']<countryRank[pNum]['sqr']){
			...
			para = senRegion + countryify2(code, label, pNum+rankToSkip) + sen3
		}
	...
	function thirdSen(param, pNum, paramArray) {
		...
		if (param == "population_val_c2011_all") {
				// TOTAL POPULATION
				return " The current population of " + place.name + " is " + val + "; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "population_val_change_all") {
				// POPULATION CHANGE
				return " Since the 2001 Census, the population of "+ place.name + " has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "age_perc_c2011_a65plus") {
				// PROPORTION OVER 65
				return " Currently, " + val + "% of residents here are over the age of 65; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "density_val_c2011_density") {
				// POPULATION DENSITY
				return " The current population density here is " + val + " people per hectare; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
				...
				return " In the last ten years, the proportion of over 65s here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "age_perc_c2011_a015") {
				// PROPORTION UNDER 16
				return " Currently, " + val + "% of residents here are under the age of 16; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "age_perc_change_a015") {
				// PROPORTION UNDER 16 CHANGE
				return " In the last ten years, the proportion of under 16s here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "medage_val_c2011_median") {
				// MEDIAN AGE
				return " The current median age of residents here is " + val + " years old; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "medage_val_change_median") {
				// MEDIAN AGE CHANGE
				return " Since the last Census, the median age here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + " years; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "economic_perc_c2011_unemployed") {
				// UNEMPLOYMENT
				return " The current rate of unemployment here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "economic_perc_change_unemployed") {
				// UNEMPLOYMENT CHANGE
				return " Since the last Census, the rate of unemployment here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "economic_perc_c2011_student") {
				// STUDENTS
				return " Currently, " + val + "% of residents here are students; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "economic_perc_change_student") {
				// STUDENTS CHANGE
				return " In the last ten years, the proportion of students here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "economic_perc_c2011_carer") {
				// CARER
				return " Currently, " + val + "% of residents here are carers; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "economic_perc_change_carer") {
				// CARER CHANGE
				return " In the last ten years, the proportion of carers here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "economic_perc_c2011_retired") {
				// RETIRED
				return " Currently, " + val + "% of residents here are retired; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "economic_perc_change_retired") {
				// RETIRED CHANGE
				return " In the last ten years, the proportion of retirees here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "economic_perc_c2011_inactive") {
				// INACTIVE
				return " The current rate of economic inactivity here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "economic_perc_change_inactive") {
				// INACTIVE CHANGE
				return " In the last ten years, the rate of economic inactivity here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "ethnicity_perc_c2011_white") {
				// ETHNICITY WHITE
				return " Currently, " + val + "% of residents here are white; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "ethnicity_perc_change_white") {
				// ETHNICITY WHITE CHANGE
				return " Since the last Census, the proportion of white residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the UK average."
		}
		else if (param == "ethnicity_perc_c2011_black") {
				// ETHNICITY BLACK
				return " Currently, " + val + "% of residents here are black; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "ethnicity_perc_change_black") {
				// ETHNICITY BLACK CHANGE
				return " In the last ten years, the proportion of black residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "ethnicity_perc_c2011_asian") {
				// ETHNICITY ASIAN
				return " Currently, " + val + "% of residents here are Asian; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "ethnicity_perc_change_asian") {
				// ETHNICITY ASIAN CHANGE
				return " Since the 2001 Census, the proportion of Asian residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "ethnicity_perc_c2011_mixed") {
				// ETHNICITY MIXED
				return " Currently, " + val + "% of residents here are of mixed ethnicity; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "ethnicity_perc_change_mixed") {
				// ETHNICITY MIXED CHANGE
				return " In the last ten years, the proportion of residents of mixed ethnicity here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "socialgrade_perc_c2011_ab") {
				// SOCIAL UPPER MIDDLE
				return " The current proportion of upper middle class residents here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "socialgrade_perc_change_ab") {
				// SOCIAL UPPER MIDDLE CHANGE
				return " In the last ten years, the proportion of upper middle class residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "socialgrade_perc_c2011_c1") {
				// SOCIAL LOWER MIDDLE
				return " The current proportion of lower middle class residents here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "socialgrade_perc_change_c1") {
				// SOCIAL LOWER MIDDLE CHANGE
				return " In the last ten years, the proportion of lower middle class residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "socialgrade_perc_c2011_c2") {
				// SOCIAL SKILLED WORKER
				return " The current proportion of skilled working class residents here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "socialgrade_perc_change_c2") {
				// SOCIAL SKILLED WORKER CHANGE
				return " In the last ten years, the amount of skilled working class residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities"
		}	
		else if (param == "socialgrade_perc_c2011_de") {
				// SOCIAL WORKING
				return " The current proportion of working class or non-working residents here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "socialgrade_perc_change_de") {
				// SOCIAL WORKING CHANGE
				return " Since the 2001 Census, the proportion of working class or non-working residents here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
		else if (param == "tenure_perc_c2011_owned") {
				// TENURE OWNERSHIP
				return " The current rate of home ownership here is " + val + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across the UK."
		}
		else if (param == "tenure_perc_change_owned") {
				// TENURE OWNERSHIP CHANGE
				return " In the last ten years, the rate of home ownership here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "tenure_perc_c2011_rentsocial") {
				// TENURE SOCIAL RENT
				return "Currently, " + val + "% of residents here live in social housing; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the national average."
		}
		else if (param == "tenure_perc_change_rentsocial") {
				// TENURE SOCIAL RENT CHANGE
				return " In the last ten years, the amount of social housing here has" + ((val < 0) ? " decreased by " : " increased by ") + Math.abs(val) + "%; " + adjectify(place.data[paramArray[0]]['rank'][changeSwitch][paramArray[3]], ['more', 'less']) + " the average across all local authorities."
		}
	...
	function countryify(code, pNum) {
		...
		function compVariable(a, b, c, d) {
			...
			let array = [], key;
			for (key in $data) {
				array.push($data[key]['data'][a][b][c][d]);
			}
 ...
 compVariable('economic','perc','c2011','unemployed')
  ...
  regionRank = ranks
	...
	function ordinal_suffix_of(i) {
		if (i == 1) {return ""} if (i == 2) {return "second"} if (i == 3) {return "third"} if (i == 4) {return "fourth"} if (i == 5) {return "fifth"} if (i == 6) {return "sixth"} if (i == 7) {return "seventh"} if (i == 8) {return "eighth"} if (i == 9) {return "ninth"}
		var j = i % 10,
				k = i % 100;
		if (j == 1 && k != 11) {
			return i + "st";
